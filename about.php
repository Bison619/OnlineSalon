      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            <div class="carousel-background"><img src="assets/images/slide-1.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Welcome to <span>Salon_Booking</span></h2>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="assets/images/slide-2.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <!-- Slide 3 -->
          <div class="carousel-item">
            <div class="carousel-background"><img src="assets/images/slide-3.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0">Project Salon_Booking</h2><p>CE084 <a href="https://github.com/Bison619" target="_blank">@Salon_Booking</a></p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
          </div>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h1>Welcome to <strong>Salon_Booking</strong></h1>
            <h1><strong>The upcoming Worldwide Leader in Online Salon Booking Service</strong></h1>
<h2>Salon Booking, a one-stop destination for all the beauty treatments, has always been working with the objective to empower men and women with beauty, finesse and confidence. With the help of our hardworking staff and colleagues, Salon Booking and Spa continues to provide world-class salon and spa services in the country. From hairdressing to gel nails to makeover, Salon Booking and Spa innovates and improves their line of products and services in order to provide great customer service and customer satisfaction.</h2>
            <p class="font-italic">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 content">
            <div class="skills-content">
              <h1><b>Rating: </b></h1>
              <div class="progress"  style="font-size:120%;">
        ...
        <div class="row" style="padding-left: 228px;">
            ...
            <div class="member">
              ...
              <div class="member-info">
                ...
                <div class="social">
                  ...
                  <a href="https://github.com/Bison619" target="_blank"><i class="fab fa-github"></i></a>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.2s">
            <div class="member">
              ...
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Sadiksha Baniya</h4>
                </div>
                <div class="social">
                  <a href=""><i class="icofont-twitter" target="_blank"></i></a>
                  <a href="https://github.com/saad" target="_blank"><i class="fab fa-github"></i></a>
