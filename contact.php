...
<body>
  ...
  <div class="contact2" style="background-image:url(assets/images/map.jpg);height: 650px;" id="contact">
    <div class="container">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group mt-3">
                          ...
                          <input style="font-size: 100%;" class="form-control" id="password" name="password" placeholder="Enter Password"
                            type="password" placeholder="Enter Your Password" required data-toggle="password">
                        </div>
                      </div>
                      <div class="col-lg-12">
                        <div class="form-group  mt-3">
                          <textarea style="font-size: 150%;" class="form-control" id="message" name="message" rows="2" required minlength="6"
                      ...
                      <?php } else { ?>
                        <div class="col-lg-12">
                          <button  style="font-size: 120%;" type="submit" class="btn btn-danger-gradiant mt-3 text-white border-0 py-2 px-3"
                            disabled><span> SUBMIT NOW <i class="ti-arrow-right"></i></span></button>
  ...
  <!-- Message Modal -->
  <div class="modal fade" id="adminReply" tabindex="-1" role="dialog" aria-labelledby="adminReply" aria-hidden="true" style="zoom:120%;">
        ...
        <div class="modal-body" id="messagebd">
          <table class="table-striped table-bordered col-md-12 text-center">
            ...
            <tbody>
              ...
              if ($count == 0) {
                ?>
                <script> document.getElementById("messagebd").innerHTML = '<div class="my-1">you have not recieve any message.</div>';</script>
                <?php
              }
              ?>
            </tbody>
  ...
  <!-- history Modal -->
  <div class="modal fade" id="history" tabindex="-1" role="dialog" aria-labelledby="history" aria-hidden="true" style="zoom:120%;">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header" style="background-color: rgb(187 188 189);">
        ...
        <div class="modal-body" id="bd">
          <table class="table-striped table-bordered col-md-12 text-center">
            ...
            <tbody>
              ...
              if ($count == 0) {
                ?>
                <script> document.getElementById("bd").innerHTML = '<div class="my-1">you have not contacted us.</div>';</script>
                <?php
              }
              ?>
            </tbody>
